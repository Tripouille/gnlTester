...
int main(void)
{
	...
	TEST(/* 1 */ gnl(fd, 1, "98765432109876543210987654321098765432109");
		 /* 2 */ gnl(fd, 1, "");
		 /* 3 */ gnl(fd, 1, "012345678901234567890123456789012345678901");
		 /* 4 */ gnl(fd, 1, "");
		 /* 5 */ gnl(fd, 1, "9876543210987654321098765432109876543210987");
		 /* 6 */ gnl(fd, 1, "");
		 /* 7 */ gnl(fd, 1, "012345678901234567890123456789012345678901");
		 /* 8 */ gnl(fd, 1, "");
		 /* 9 */ gnl(fd, 0, "98765432109876543210987654321098765432109");
		 /* 10 */ gnl(fd, 0, "");) cout << ENDL; close(fd);

	cout << FG_LGRAY << "files/alternate_line_nl_with_nl: "; cout.flush();
	fd = open("files/alternate_line_nl_with_nl", O_RDWR);
	TEST(/* 1 */ gnl(fd, 1, "01234567890123456789012345678901234567890");
		 /* 2 */ gnl(fd, 1, "");
		 /* 3 */ gnl(fd, 1, "987654321098765432109876543210987654321090");
		 /* 4 */ gnl(fd, 1, "");
		 /* 5 */ gnl(fd, 1, "0123456789012345678901234567890123456789012");
		 /* 6 */ gnl(fd, 1, "");
		 /* 7 */ gnl(fd, 1, "987654321098765432109876543210987654321090");
		 /* 8 */ gnl(fd, 1, "");
		 /* 9 */ gnl(fd, 1, "01234567890123456789012345678901234567890");
		 /* 10 */ gnl(fd, 0, "");) cout << ENDL; close(fd);

	std::string result;
	for (int i = 0; i < 1000; ++i)
		result += "0123456789";
	cout << FG_LGRAY << "files/big_line_no_nl: "; cout.flush();
	fd = open("files/big_line_no_nl", O_RDWR);
	TEST(/* 1 */ gnl(fd, 0, result.c_str());) cout << ENDL; close(fd);

	cout << FG_LGRAY << "files/big_line_with_nl: "; cout.flush();
	fd = open("files/big_line_with_nl", O_RDWR);
	TEST(/* 1 */ gnl(fd, 1, result.c_str());
		 /* 2 */ gnl(fd, 0, "");) cout << ENDL; close(fd);
	...
	TEST(/* 1 */ gnl(0, 1, "01234567890123456789012345678901234567890");
		 /* 2 */ gnl(0, 1, "");
		 /* 3 */ gnl(0, 1, "987654321098765432109876543210987654321090");
		 /* 4 */ gnl(0, 1, "");
		 /* 5 */ gnl(0, 1, "0123456789012345678901234567890123456789012");
		 /* 6 */ gnl(0, 1, "");
		 /* 7 */ gnl(0, 1, "987654321098765432109876543210987654321090");
		 /* 8 */ gnl(0, 1, "");
